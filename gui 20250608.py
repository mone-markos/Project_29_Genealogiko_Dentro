...
def open_add_person_window():
    ...
    Label(add_window, text="Περιγραφή (προαιρετικά):").pack()
    ...
    def save_person():
        ...
        if first_name and last_name and birth_date:
            new_id = add_person(first_name, last_name, birth_date, description)  # Λήψη του νέου ID
...
def open_edit_person_window():
    ...
    Label(edit_window, text="Περιγραφή (προαιρετικά):").pack()
    ...
    def save_updated_person():
        ...
        if person_id.isdigit():
            update_person(person_id, first_name, last_name, birth_date, description)
